...
<section class="admBody">
    <?php
      ...
      echo "<form action='includes/deleteServices.inc.php' method='post'>";
      echo "<select name='services'>";

      require('includes/dbh.inc.php');

      $sql = "SELECT * FROM clinic AS C, services_provided AS S WHERE C.ID = S.CID;";
      ...
      while($row = mysqli_fetch_assoc($resultData)) {
        $clinic[] = array($row['ID'], $row['Name'], $row['ServiceCode']);
      }
